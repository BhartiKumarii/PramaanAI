...
// Ported verbatim from nexus-saa-s-ai-platform/components/landing/ascii-wave.tsx
// (purely decorative canvas art, no framework dependency) — only the
// "use client" directive was dropped, nothing else changed.
