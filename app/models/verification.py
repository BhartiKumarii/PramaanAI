...
class VerificationRecord(Base):
    ...
    duplicate_document_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    face_detection_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    citizen_registry_json: Mapped[str | None] = mapped_column(Text, nullable=True)
